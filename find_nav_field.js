...
async function findNavField() {
    ...
    const result = json.data.__schema.types.filter(t => t.fields && t.fields.some(f => f.name.toLowerCase().includes('nav')));
    console.log(JSON.stringify(result, null, 2));
}

findNavField().catch(console.error);
