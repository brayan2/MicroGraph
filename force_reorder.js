...
const getUniqueUrl = (url) => {
  ...
  return `${base}?uid=${Date.now()}-${Math.random().toString(36).substr(2, 5)}`;
};
...
async function main() {
  ...
  // Define the NEW order (Create Inputs with 'data' wrapper and Unique URLs)
  ...
  // 3. EXECUTE: Delete All Old -> Create All New
