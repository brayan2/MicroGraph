...
async function main() {
    console.log("Fetching a sample product to check price structure...\n");
  ...
  `);
    ...
    if (data?.products) {
        ...
        data.products.forEach(p => {
            ...
            console.log(`  productPrice: ${p.productPrice ? JSON.stringify(p.productPrice) : 'null'}`);
            console.log(`  productPrice?.price: ${p.productPrice?.price}`);
        });
    }
}
