...
async function checkQuery() {
    ...
    console.log("subNavs in Query:", fields.includes("subNavs"));
    console.log("subNav in Query:", fields.includes("subNav"));
    console.log("subNavigation in Query:", fields.includes("subNavigation"));
    console.log("navItems in Query:", fields.includes("navItems"));
    console.log("navItem in Query:", fields.includes("navItem"));
}
