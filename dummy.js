...
async function fetchSubNavs() {
    // We can't query subNavs directly if they are components.
    // But they might be models. If they are models, they should be in Query.
    // I checked Query and they were NOT there.
    // Wait, if they are components, they are always embedded.

    // Let's check LandingPage, maybe the user added them there?
    // "updated the schema on the cms for the navigation model"

    // Maybe they are in the Navigation model but I missed them?
