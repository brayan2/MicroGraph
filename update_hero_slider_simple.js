...
async function main() {
  ...
  `);
    ...
    // Known slider ID from previous run
    const sliderId = "cmkuvwpbyv18k072n2wmzp428";

    console.log(`\nUpdating HeroSlider ${sliderId} with products...`);
